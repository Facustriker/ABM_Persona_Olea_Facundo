        ...
        <ModalBody>
          ...
          <Form id="contenedorCamposFormulario">
            ...
            <FormGroup className="mb-3" controlId="formNombre">
              ...
              <input type="text" name='nombre' id='nombre' onChange={this.handleChange} value={form.nombre}/>
              <br />
            </FormGroup>
            ...
            <FormGroup className="mb-3" controlId="formPassword">
              ...
              <input type="text" name='password' id='password' onChange={this.handleChange} value={form.password}/>
              <br />
            </FormGroup>
            ...
            <FormGroup className="mb-3" controlId="formEmail">
              ...
              <input type="text" name='email' id='email' onChange={this.handleChange} value={form.email}/>
              <br />
            </FormGroup>

            <FormGroup className="mb-3" controlId="formEmail">
              <label htmlFor="firstname">Legajo</label>
              <input type="text" name='legajo' id='legajo' onChange={this.handleChange} value={form.legajo}/>
              <br />
            </FormGroup>
            ...
            <FormGroup className="mb-3" controlId="formApellido">
              ...
              <input type="text" name='apellido' id='apellido' onChange={this.handleChange} value={form.apellido}/>
              <br />
            </FormGroup>
            ...
            <FormGroup className="mb-3" controlId="formTelefono">
              ...
              <input type="number" name='telefono' id='telefono' onChange={this.handleChange} value={form.telefono}/>
              <br />
            </FormGroup>
            ...
            <FormGroup className="mb-3" controlId="formRol">
              ...
              <input type="text" name='rol' id='rol' onChange={this.handleChange} value={form.rol}/>
              <br />
            </FormGroup>
            </div>
